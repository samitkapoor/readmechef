...
const GridDivider = ({
  ...
  return (
    <div
      ...
      className="flex flex-col border-y-[1px] border-primary/40 items-center justify-center bg-white/10 w-full"
    >
      <div
        style={
          enableBackground
        ...
        className="border-[1px] border-y-0 border-primary/40 max-w-[1300px] bg-background h-[150px] md:h-[200px] lg:h-[250px] w-full flex items-center justify-center"
      >
        {children}
      </div>
    </div>
