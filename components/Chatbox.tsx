...
const Chatbox = ({
  ...
  return (
    <div
      ...
      className="w-full h-full border-gray-700 grid grid-cols-1 shadow-md relative scrollbar-hide"
    >
      <div className="flex flex-col flex-nowrap shrink-0 pb-4 overflow-y-auto w-full relative scrollbar-hide">
        <div className="w-full flex items-center justify-start mt-10 text-white/70 text-sm mb-1">
        ...
        {messages.map((message) => {
          ...
          return (
            <div
              key={message.id}
              className={`p-3 rounded-lg mb-4 overflow-x-auto shrink-0 scrollbar-hide ${
                message.role === 'user'
